...
describe('stack-overflow', () => {
  ...
  test('undefined as value', {a:undefined, b:2})  // { b: 2 }
  test('undefined as key', {undefined: 1})        // { undefined: 1 }
  test('undefined as key', {undefined: 1})        // { undefined: 1 }
  test('null as key', {null: 1})                  // { null: 1 }
...
function test(testName: string, value: any, shape?: string, isEqual = true) {
